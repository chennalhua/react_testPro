...
const CustomerQuery = () => {
    ...
    const getVisitFun = () => {
        ...
        let API = `${process.env.REACT_APP_GOLDEN_MagentAPI}magent/queryVisitCustomer`
        let data = {
    ...
    return (
        <>
            ...
            <div className={`container ${option === '約訪紀錄' ? 'd-block' : 'd-none'}`} style={{ background: 'rgba(255,255,255,50%)' }}>
